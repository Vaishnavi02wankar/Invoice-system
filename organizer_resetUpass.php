...
$con = mysqli_connect("localhost","root","","event_management");
    ...
    $sql = "select * from organizer_reg where email='$uemail' && ans='$uans'";
            ...
            <div class="col-sm-6" style="margin-left:25%">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form name="myForm" class="form-horizontal" method="post" action="organizer_resetUpassController.php">
                        ...
                        <strong><a href="organizer_forgetUpass.php" style="color:#337ab7;float: left;">back</a></strong>
                    </div>
                </div>
            </div>
        </div>
