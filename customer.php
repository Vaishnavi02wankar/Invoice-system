        ...
        <div class="row">
            <div class="col-sm-6" style="margin-left:25%">
                <div class="panel panel-primary">
                    <div class="panel-heading"><strong>Customer Login</strong></div>
                    <div class="panel-body">
                        <form onsubmit="return login()" name="myForm" class="form-horizontal" method="post" action="customer_loginController.php" autocomplete="off">
                            <div class="form-group">
                                <label class="control-label col-sm-2">Username:</label>
                                <div class="col-sm-10">
                                    <input type="email" class="form-control" name="uname" placeholder="Enter Email" autofocus />
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <strong><a href="customer_forgetUpass.php" style="color:#337ab7;float: left;">forget password ?</a></strong>
