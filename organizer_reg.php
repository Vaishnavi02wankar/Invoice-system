<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "insert into organizer_reg(uname,email,password,dob,gender,address,contact,ans) values('$uname','$uemail','$upass','$udob','$gender','$uaddr','$umob','$uans')";
...
<body data-spy="scroll" data-offset="50" data-target=".navbar-collapse">
    ...
    <!-- start organizer registration form -->
    <div class="container" style="margin-top: 150px;">
        <div class="row">
            <div class="col-sm-6" style="margin-left:25%">
                <div class="panel panel-primary">
                    <div class="panel-heading"><strong>Organization Registration</strong></div>
                    <div class="panel-body">
                        <form name="myForm" onsubmit="return checkReg()" class="form-horizontal" method="post" autocomplete="off">
                            <div class="form-group">
                                <label class="control-label col-sm-2">Username:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="uname" placeholder="Enter name" autofocus />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    <a href="organizer.php" class="btn btn-primary">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <!-- end organizer registration form -->
