...
<body data-spy="scroll" data-offset="50" data-target=".navbar-collapse">
    ...
    <!-- start organizer login form -->
    <div class="container" style="margin-top: 150px;">
        <div class="row">
            <div class="col-sm-6" style="margin-left:25%">
                <div class="panel panel-primary">
                    <div class="panel-heading"><strong>Organizer Login</strong></div>
                    <div class="panel-body">
                        <form onsubmit="return login()" name="myForm" class="form-horizontal" method="post" action="organizer_loginController.php" autocomplete="off">
                            <div class="form-group">
                                <label class="control-label col-sm-2">Username:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="uname" placeholder="Enter Email" autofocus />
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <strong><a href="organizer_forgetUpass.php" style="color:#337ab7;float: left;">forget password ?</a></strong>
                        <strong><a href="organizer_reg.php" style="color:#337ab7;float: right;">New Organizer ?</a></strong>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <!-- end organizer login form -->
