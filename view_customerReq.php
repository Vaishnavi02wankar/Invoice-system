...
<body data-spy="scroll" data-offset="50" data-target=".navbar-collapse">
    ...
    <!-- start view customer request -->
    <div class="container" style="margin-top: 150px;">
        <div class="panel panel-primary">
            <div class="panel-heading"><strong>View Customer's Request</strong></div>
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>Organizer</th>
                            <th>Status</th>
                            <th>Forward to Organizer</th>
                            <th>Accept Request</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                            $sql = "select * from customer_req order by id";
                        ...
                        <tr>
                            ...
                            <td><center><a href="forward_reqController.php?id=<?php echo $row['id'] ?>" class="btn btn-primary btn-xs">Click Here</a></center></td>
                            <td><center><a href="customer_acceptReq.php?id=<?php echo $row['id'] ?>" class="btn btn-primary btn-xs">Yes</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="customer_rejectReq.php?id=<?php echo $row['id'] ?>" class="btn btn-primary btn-xs">No</a></center></td>
                        </tr>
                        <?php }} ?>
                    </tbody>
                </table>
