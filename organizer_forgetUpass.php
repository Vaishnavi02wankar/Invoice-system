            ...
            <div class="col-sm-6" style="margin-left:25%">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form name="myForm" class="form-horizontal" method="post" action="organizer_resetUpass.php" autocomplete="off">
                        ...
                        <strong><a href="organizer.php" style="color:#337ab7;float: left;">back</a></strong>
