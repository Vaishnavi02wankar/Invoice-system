...
<body data-spy="scroll" data-offset="50" data-target=".navbar-collapse">
    ...
    <!-- start add_venue form -->
    <div class="container" style="margin-top: 150px;">
        <div class="row">
        <div class="col-sm-6" style="margin-left:25%">
                <div class="panel panel-primary">
                    <div class="panel-heading"><strong>Add Venue</strong></div>
                    <div class="panel-body">
                        <form name="myForm" onsubmit="return checkVenue()" class="form-horizontal" method="post" action="add_venueController.php" autocomplete="off">
                            <div class="form-group">
                                <label class="control-label col-sm-2">Venue:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="venue" placeholder="Enter venue" autofocus />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-2">Event:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="event" placeholder="Enter event">
                                </div>
                            </div>
                            <div class="form-group">
